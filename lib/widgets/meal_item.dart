...
class MealItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
        ...
        clipBehavior: Clip.hardEdge, // вырезает углы
        elevation: 2,
        child: InkWell(
          onTap: () {
            ...
            children: [
              Hero(
                ...
                child: FadeInImage(
                  ...
                  fit: BoxFit
                      .cover, // makes sure that the image will not be stretched and ruined
                  height: 200,
                    ...
                    children: [
                      Text(meal.title,
                          ...
                          style: const TextStyle(
                            ...
                            color: Colors.white,
                          )), //very long text will be cut off and replaced with ellipsis
